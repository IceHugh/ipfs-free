...
var IpfsFree = /** @class */ (function () {
    ...
    function IpfsFree(providers, options) {
    ...
    IpfsFree.prototype.getUploadClinet = function () {
        ...
        var currentConfigs = Object.keys(this.providers);
        var providerType = this.providers[type] ? type : currentConfigs[0];
        var clientType = providerType;
        if (random) {
        ...
        var providerConfig = this.getProviderConfig(clientType);
        var client = new Client(providerConfig);
        return client;
    };
    IpfsFree.prototype.getProviderConfig = function (type) {
        var providerConfig = this.providers[type];
        var _providerConfig = providerConfig === null || providerConfig === void 0 ? void 0 : providerConfig[0];
        var configLen = providerConfig === null || providerConfig === void 0 ? void 0 : providerConfig.length;
    ...
    IpfsFree.prototype.getDeleteClinet = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var types, type, Client, proveiderConfig, client;
            return __generator(this, function (_a) {
                ...
                proveiderConfig = this.getProviderConfig(type);
                client = new Client(proveiderConfig);
